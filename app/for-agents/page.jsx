...
export default function ForAgentsPage() {
  ...
  const steps = [
    { num: '1', title: 'נרשמים בחינם למערכת', desc: 'פתיחה של חשבון לוקחת רגע.', icon: Users },
    { num: '2', title: 'מקבלים קישור אישי למוצרים', desc: 'המערכת נותנת לך קישור משלך.', icon: Gift },
    { num: '3', title: "לוחצים 'שיתוף' ושולחים לחברים", desc: 'אפשר לשתף בכל מקום שאתה כבר רגיל אליו.', icon: Share2 },
    { num: '4', title: 'מישהו קנה? אתה מקבל כסף', desc: 'המערכת מזהה אוטומטית ומעדכנת את הרווח שלך.', icon: Wallet },
  ];

  const benefits = [
    { icon: Wallet, title: 'לא צריך למכור', desc: 'רק לשתף קישור.' },
    { icon: BarChart3, title: 'לא צריך לדבר עם לקוחות', desc: 'הכל עובד אוטומטית.' },
    { icon: Link2, title: 'לא צריך מלאי', desc: 'אין התעסקות עם סחורה.' },
    { icon: QrCode, title: 'רק לשתף קישור', desc: 'בכל רשת חברתית.' },
    { icon: Users, title: 'כל קנייה מזכה אותך בכסף', desc: 'המערכת עוקבת ומחשבת.' },
    { icon: CreditCard, title: 'אפשר למשוך לחשבון הבנק', desc: 'כשיש לך יתרה.' },
    { icon: Globe, title: 'עובד גם לחברים וגם לעוקבים', desc: 'כל מי שקונה דרך הקישור שלך.' },
  ];
    ...
    <div className="min-h-screen w-full" style={{ backgroundColor: colors.light }}>
      ...
      <section className="relative pt-8 pb-16 sm:pt-12 sm:pb-20 px-4 sm:px-6" style={{ background: gradient }}>
        ...
        <div className="relative max-w-4xl mx-auto text-center text-white">
          ...
          <h1 className="text-2xl sm:text-4xl font-bold mb-4 opacity-0-start animate-fadeInUp delay-100">
            יש לך חברים? אפשר להרוויח כסף רק מלשלוח להם מוצרים
          </h1>
          
          <p className="text-base sm:text-lg leading-relaxed mb-6 max-w-2xl mx-auto opacity-0-start animate-fadeInUp delay-200">
            מצטרפים בחינם, מקבלים קישור אישי למוצרים,
            <br className="hidden sm:block" />
            שולחים לחברים או עוקבים — וכל קנייה מזכה אותך בכסף.
          </p>

          {/* Stats */}
          <div className="flex justify-center gap-8 sm:gap-12 mb-6 opacity-0-start animate-fadeInUp delay-300">
            {[
              { value: '24/7', label: 'המערכת עובדת בשבילך כל הזמן' },
              { value: '0₪', label: 'ההצטרפות חינם לגמרי' },
              { value: 'עד 12%', label: 'כסף על כל קנייה דרך הקישור שלך' },
            ].map((stat, idx) => (
      ...
      <section className="py-10 sm:py-14 px-4 sm:px-6 bg-white">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mt-8 text-center">
            <h3 className="text-base sm:text-lg font-bold mb-2" style={{ color: colors.primary }}>
              איפה אפשר לשתף?
            </h3>
            <p className="text-sm sm:text-base leading-relaxed" style={{ color: colors.textLight }}>
              בלחיצה אחת אפשר לשתף בוואטסאפ, פייסבוק, אינסטגרם, טלגרם, קבוצות, סטטוס והודעות פרטיות.
              <br className="hidden sm:block" />
              לא צריך להבין בשיווק — רק לשתף כמו שאתה כבר רגיל.
            </p>
          </div>

          <div className="mt-6 text-center">
            <p className="text-sm sm:text-base leading-relaxed font-medium" style={{ color: colors.text }}>
              דוגמה:
              <br />
              שלחת מוצר ל-10 חברים,
              <br />
              2 קנו,
              <br />
              קיבלת כסף.
      ...
      <section className="py-10 sm:py-14 px-4 sm:px-6 bg-white">
        <div className="max-w-2xl mx-auto">
          <div className="text-center mb-8">
            <h2 className="text-xl sm:text-2xl font-bold mb-2" style={{ color: colors.primary }}>
              מערכת העמלות — פשוטה ושקופה
            </h2>
            <div className="w-16 h-1 mx-auto rounded-full" style={{ background: gradient }} />
            <p className="text-sm sm:text-base leading-relaxed" style={{ color: colors.textLight }}>
              על כל מוצר שנקנה דרך הקישור שלך — המערכת מזהה אוטומטית ומעבירה לך כסף.
            </p>
          </div>
      ...
      <section className="relative py-12 sm:py-16 px-4 sm:px-6" style={{ background: gradient }}>
        ...
        <div className="relative max-w-2xl mx-auto text-center text-white">
          ...
          <p className="text-sm sm:text-base mb-6 opacity-90">
            נרשמים בחינם, מקבלים קישור אישי, ומשתפים בלחיצה אחת.
          </p>
